...
<?php include(app_path().'/includes/header.php');?>
	...
	<div class = "row" style=" background-color: white; border-radius:15px; padding: 15px 10px; border-style: solid; border-color: black">
		<div class = "col" align="center">
			...
			<div class = "col" style="background-image: url('wood.jpeg'); border-radius: 10px; border-style:solid;">
				<div style="padding: 10px 10px;"> <img src="house.png" alt="A house" style="height: 100%; width: 90%; padding:35px 0px;"> </div>
			</div>
			<div class = "col">
