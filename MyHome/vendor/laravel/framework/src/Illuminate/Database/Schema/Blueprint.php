...
class Blueprint
{
    ...
    {
        $this->dropColumn('create_datetime');
    }
    ...
    {
        $this->timestamp('create_datetime', $precision)->nullable();
    }
    ...
    {
        $this->timestampTz('create_datetime', $precision)->nullable();
    }
    ...
    {
        $this->datetime('create_datetime', $precision)->nullable();
    }
